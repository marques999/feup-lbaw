...
<h5 class="slab half-top-padding">
  <a href="{$smarty.server.HTTP_HOST}{$smarty.server.REQUEST_URI}">Mensagens Privadas</a>
  &gt;&nbsp;mellus
</h5>


<!-- MENSAGEM 1: painel esquerdo (autor) -->
...
<!-- MENSAGEM 1: painel direito (cabeçalho) -->
...
<!-- MENSAGEM 2: painel esquerdo (autor) -->
...
<!-- MENSAGEM 2: painel direito (cabeçalho) -->
<div class="column all-85 medium-80 small-75 tiny-75">
<div class="message-header">
