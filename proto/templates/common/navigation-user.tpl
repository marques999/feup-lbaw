...
<ul class="menu horizontal black push-left hide-all show-small show-tiny small-push-center tiny-push-center">
  ...
  <li id="nav-profile" class="medium">
    ...
    <ul class="submenu fw-600">
      ...
      <li><a href="{$BASE_DIR}/pages/users/profile.php#profile">Perfil</a></li>
      <li><a href="{$BASE_DIR}/pages/users/profile.php#questions">Gerir perguntas</a></li>
      <li><a href="{$BASE_DIR}/pages/users/profile.php#answers">Gerir respostas</a></li>
      <li><a href="{$BASE_DIR}/pages/users/logout.php">Terminar sessão</a></li>
    </ul>
  </li>
</ul>
