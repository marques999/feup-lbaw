...
<div class="column-group half-top-space quarter-bottom-space">
  ...
  <div class="message all-100 half-bottom-space">
    <h5 class="slab no-margin">
      ...
      &nbsp;<i class="fa fa-angle-right"></i>&nbsp;
      <a class="black" href="{$BASE_URL}pages/instituicao/edit.php">Criar instituição</a>
    </h5>
  </div>
</div>
{/block}
...
<form action="{$BASE_URL}actions/instituicao/submit.php" method="post" class="ink-form ink-formvalidator half-vertical-padding medium all-100 xlarge-60 large-75 medium-85 push-center" data-lang="pt_PT">
