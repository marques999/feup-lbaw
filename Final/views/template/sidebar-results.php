...
<!-- BARRA LATERAL: pesquisa avançada -->
...
<ul class="menu vertical white">
    <li class="active"><a href="#">Nome</a></li>
    <li><a href="categoria/1">Data (mais recentes)</a></li>
    <li><a href="#">Data (mais antigas)</a></li>
    <li><a href="#">Pontuação (crescente)</a></li>
    <li><a href="#">Pontuação (decrescente)</a></li>
    <li><a href="#">Respostas (crescente)</a></li>
    <li><a href="#">Respostas (decrescente)</a></li>
</ul>
