...
<!-- REGISTO: formulário -->
<form action="actions/action_create_user.php" method="post" enctype="multipart/form-data" class="ink-form medium ink-formvalidator">
<fieldset>
...
<!-- REGISTO: endereço e-mail / faculdade -->
<div class="control-group column-group half-gutters required">
...
<?
  require_once(__DIR__ . '/template/footer_empty.php');
?>